...
/**
 * A form component for TOTP setup during sign-in.
 *
 * This component provides a complete TOTP (Time-based One-Time Password) setup
 * flow for users who need to configure MFA. It includes:
 * - QR code generation for authenticator apps
 * - Manual secret key display and copy functionality
 * - OTP code verification
 * - Loading states and error handling
 * - Integration with AWS Amplify auth
 *
 * @param props - Component props including state management and user email
 * @returns TotpSetupForm component with complete TOTP setup functionality
 */
