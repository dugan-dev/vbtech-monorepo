...
import * as AdminPhysiciansRoute from "@/app/(authed)/admin/physicians/page.info";
...
export const AdminPhysicians = makeRoute("/(authed)/admin/physicians", {
  ...defaultInfo,
  ...AdminPhysiciansRoute.Route,
});
