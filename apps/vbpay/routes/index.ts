...
import * as ManagePaymentBatchesRoute from "@/app/(authed)/payment/batches/page.info";
import * as PaymentPlanningRoute from "@/app/(authed)/payment/planning/page.info";
import * as ManagePaymentRatesRoute from "@/app/(authed)/payment/rates/page.info";
...
export const ManagePaymentBatches = makeRoute("/(authed)/payment/batches", {
  ...defaultInfo,
  ...ManagePaymentBatchesRoute.Route,
});
export const PaymentPlanning = makeRoute("/(authed)/payment/planning", {
  ...defaultInfo,
  ...PaymentPlanningRoute.Route,
});
export const ManagePaymentRates = makeRoute("/(authed)/payment/rates", {
  ...defaultInfo,
