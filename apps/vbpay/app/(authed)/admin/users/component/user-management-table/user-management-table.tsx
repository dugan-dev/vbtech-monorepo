...
/**
 * Renders the user management table with options to add and synchronize users.
 *
 ...
 *
 * @param users - The list of users to display. If empty, the empty state is shown.
 ...
 *
 * @returns The user management interface as a React element.
 */
