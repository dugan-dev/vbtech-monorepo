 ...
 *
 * Awaits query and route parameters, verifies user authentication, enforces rate limiting, and restricts access to specific user types. Displays payer information, configuration, and processing account sections, each with a loading skeleton while data is being fetched.
 *
