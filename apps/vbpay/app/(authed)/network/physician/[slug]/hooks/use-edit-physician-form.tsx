 ...
 *
 * Returns form methods, a submission handler, loading and error dialog states, and a flag indicating whether the current user has permission to edit the physician.
 *
