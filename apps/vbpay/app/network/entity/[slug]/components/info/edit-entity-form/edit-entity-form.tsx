 ...
 *
 * The form displays fields for entity type, marketing name, legal name, acronym/nickname, organizational NPI, and tax ID. Editing is gated by the `isEditing` prop, and form submission invokes the provided `onSuccess` callback on success. An error dialog is shown if submission fails.
 *
 ...
 * @param payerPubId - Identifier for the payer entity.
 */
